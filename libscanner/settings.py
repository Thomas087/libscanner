...
# Redis connection pool settings for Heroku (conservative to reduce memory)
...
# Expire task results after 1 hour so Redis does not fill up (avoids OOM)
CELERY_RESULT_EXPIRES = 60 * 60  # 3600 seconds
...
CELERY_BEAT_SCHEDULE = {
    'daily-animal-scraping': {
        ...
        'schedule': crontab(hour=11, minute=10),  # Run every day at 10:40 AM (Europe/Paris timezone)
